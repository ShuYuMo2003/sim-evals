"""
Run DROID evaluation with the DreamZero-style 3-view joint-position client.
"""
...
from sim_evals.inference.dreamzero_jointpos import Client as DreamZeroJointPosClient
...
def main(
    ...
    parser = argparse.ArgumentParser(description="Run DROID evaluation with DreamZero joint-position client.")
